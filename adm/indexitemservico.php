                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="modal" data-target="#modalcaditens" style="cursor: pointer;">Registrar serviço</a>
                                    </li>
                              
                                  
                                </ul>
                                <form class="form-inline my-2 my-lg-0" action="indexitemservico.php" method="POST">
